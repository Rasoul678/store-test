<nav class="navbar navbar-expand-md navbar-light bg-light shadow-sm mb-2">
    <div class="container">
        <a class="navbar-brand waves-effect waves-light d-md-none small-sc" href="{{route('cart.index')}}" >
            <i class="fa fa-shopping-cart"></i>
        </a>
        <a class="navbar-brand hover-link" href="{{ url('/') }}">Home</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-3">
            ...
            <ul class="navbar-nav ml-auto nav-flex-icons">
                ...
                <li class="nav-item mr-md-2 d-none d-md-inline">
                    <a class="nav-link waves-effect waves-light big-sc" href="{{route('cart.index')}}" >
                        <i class="fa fa-shopping-cart"></i>
                    </a>
                </li>
